...
public class MainCharacter {
	...
	public MainCharacter() {
		...
		normalRunAnim.addFrame(Resource.getResourceImage("data/ch1.png"));
		normalRunAnim.addFrame(Resource.getResourceImage("data/ch2.png"));
		normalRunAnim.addFrame(Resource.getResourceImage("data/ch3.png"));
		jumping = Resource.getResourceImage("data/ch4.png");
		downRunAnim = new Animation(90);
		downRunAnim.addFrame(Resource.getResourceImage("data/ch7.png"));
		deathImage = Resource.getResourceImage("data/ch5.png");
		try {
			jumpSound =  Applet.newAudioClip(new URL("file","","data/jump.wav"));
			deadSound =  Applet.newAudioClip(new URL("file","","data/Bruh.wav"));
			highScoreSound =  Applet.newAudioClip(new URL("file","","data/Highscore.wav"));
